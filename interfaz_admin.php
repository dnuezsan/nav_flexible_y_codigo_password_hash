...
<body>
    ...
    <nav>
        ...
        <div class="enlaces_nav" id="caja3"><a href="#">Gestión de empleados</a></div>
        <div class="enlaces_nav" id="ultima"><a href="cerrar_sesion.php">Cerrar Sesión</a></div>
    </nav>
    <h1 id="pagina">Bienvenido admin</h1>
    <aside>
        ...
        <form action="" method="POST">
            <table>
                <tr class="campos">
                    ...
                    <td class="entradas"><input type="text" name="dni"></td>
